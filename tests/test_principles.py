...
P5_CASES = [
    ...
    ("pre_diff_prompt_describes_reprogramme_as_profile_maintenance", lambda: "`reprogramme_needed` = write semantic state into entity/admin-style profiles after that judgment is already warranted." in loop.PRE_DIFF_SYSTEM),
