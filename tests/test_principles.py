...
P11_CASES = [
    ...
    ("render_chain_includes_runtime_legend", lambda: (lambda ctx: "legend: step{kindflowN}" in ctx.traj.render_chain(next(iter(ctx.traj.chains)), registry()))(build_chain_context())),
